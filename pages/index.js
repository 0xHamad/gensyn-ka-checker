      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <div className="inline-block">
            <div className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg">
              Created by Hamad
            </div>
          </div>
        ...
        {!result && (
          <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-3 text-white/70 text-sm">
              <p>• Estimates allocation based on wallet address patterns</p>
              <p>• Uses testnet score, hardware tier, early adoption, and uptime factors</p>
              <p>• Total airdrop pool: 160M tokens (1.6% of 10B supply)</p>
              <p>• Results are consistent - same address always gives same result</p>
            </div>
          </div>
        )}
      </div>
